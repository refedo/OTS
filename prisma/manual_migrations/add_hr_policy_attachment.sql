...
SELECT UUID(), 'Annual Leave Policy', 'سياسة الإجازة السنوية',
  ...
  'HR', 'v1.0', CURDATE(), 'ACTIVE', (SELECT id FROM User WHERE roleId = (SELECT id FROM Role WHERE name = 'Admin') LIMIT 1), NOW(), NOW()
...
SELECT UUID(), 'Code of Conduct', 'مدونة السلوك المهني',
  ...
  'Conduct', 'v1.0', CURDATE(), 'ACTIVE', (SELECT id FROM User WHERE roleId = (SELECT id FROM Role WHERE name = 'Admin') LIMIT 1), NOW(), NOW()
...
SELECT UUID(), 'Workplace Safety Policy', 'سياسة السلامة في مكان العمل',
  ...
  'Safety', 'v1.0', CURDATE(), 'ACTIVE', (SELECT id FROM User WHERE roleId = (SELECT id FROM Role WHERE name = 'Admin') LIMIT 1), NOW(), NOW()
...
SELECT UUID(), 'IT Security & Acceptable Use Policy', 'سياسة أمن المعلومات والاستخدام المقبول',
  ...
  'IT', 'v1.0', CURDATE(), 'ACTIVE', (SELECT id FROM User WHERE roleId = (SELECT id FROM Role WHERE name = 'Admin') LIMIT 1), NOW(), NOW()
...
SELECT UUID(), 'Expense Reimbursement Policy', 'سياسة تعويض المصاريف',
  ...
  'Finance', 'v1.0', CURDATE(), 'ACTIVE', (SELECT id FROM User WHERE roleId = (SELECT id FROM Role WHERE name = 'Admin') LIMIT 1), NOW(), NOW()
