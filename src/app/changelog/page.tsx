...
const hardcodedVersions: ChangelogVersion[] = [
  {
    ...
    type: 'major',
    status: 'current',
    mainTitle: '🎯 Major Release: UI Fixes & System Stability',
    highlights: [
      'Removed broken Appearance/Theme system causing UI corruption',
      'Restored clean default muted theme across all pages',
      'Added password visibility toggle to login form',
      'Fixed 400+ lines of problematic glass morphism CSS',
    ],
    changes: {
      added: [
        {
