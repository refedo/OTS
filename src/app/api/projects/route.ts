      ...
      select: {
        ...
        validation: {
          select: {
            ...
            projectsStepNotes: true,
            projectsStatus: true,
            operationsValidatedById: true,
            operationsValidatedAt: true,
            operationsValidatedBy: { select: { id: true, name: true } },
            operationsStepNotes: true,
            operationsStatus: true,
          },
        },
        buildings: { select: { id: true, designation: true, name: true, archDrawingsReceived: true } },
        setupChecklist: { select: { contractReceived: true } },
