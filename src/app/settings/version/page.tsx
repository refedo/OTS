          ...
          <div className="space-y-3">
            ...
            <div className="ml-10 space-y-2">
              <div className="space-y-2">
                ...
                <div className="bg-slate-900 text-slate-100 p-3 rounded-lg font-mono text-sm flex items-center justify-between">
                  <span>git commit -m "chore: release v2.13.2"</span>
                  <Button
                    size="sm"
                    variant="ghost"
                    onClick={() => copyToClipboard('git commit -m "chore: release v2.13.2"', 'commit')}
                  >
                    {copied === 'commit' ? 'Copied!' : 'Copy'}
                  </Button>
                </div>
                <div className="bg-slate-900 text-slate-100 p-3 rounded-lg font-mono text-sm flex items-center justify-between">
                  <span>git tag -a v2.13.2 -m "Release v2.13.2"</span>
                  <Button
                    size="sm"
                    variant="ghost"
                    onClick={() => copyToClipboard('git tag -a v2.13.2 -m "Release v2.13.2"', 'tag')}
                  >
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <div className="bg-slate-900 text-slate-100 p-3 rounded-lg font-mono text-xs">
                ...
                <div>wget https://github.com/{GITHUB_REPO}/releases/download/v2.13.2/hexa-steel-ots-v2.13.2.tar.gz</div>
                <div className="mt-2"># 2. Stop app</div>
                <div>pm2 stop ots-app</div>
                <div className="mt-2"># 3. Extract</div>
                <div>tar -xzf hexa-steel-ots-v2.13.2.tar.gz -C /var/www/hexasteel.sa/ots</div>
