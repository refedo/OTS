...
const OTS_FIELDS = {
  projects: [
    ...
    { value: 'payment_2', label: 'Payment 2' },
    { value: 'payment_3', label: 'Payment 3' },
    { value: 'payment_4', label: 'Payment 4' },
    { value: 'payment_5', label: 'Payment 5' },
    { value: 'payment_6', label: 'Payment 6' },
