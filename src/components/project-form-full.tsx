          ...
          <div className="pt-4 border-t">
            ...
            <div className="grid gap-4">
              {[
                ...
                } else if ((project as any)[payment.key] && project.contractValue) {
                  // Fallback: calculate percentage from amount for old projects
                  percentageValue = (((project as any)[payment.key] / project.contractValue) * 100).toFixed(2);
                }
