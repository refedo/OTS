...
export const PERMISSIONS: PermissionCategory[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      // Gap-fill permissions (22.2.0)
      { id: 'ims.legalRegister.view', name: 'View Legal Register', description: 'View legal & regulatory register (ISO §6.1.3)', category: 'ims' },
      { id: 'ims.legalRegister.manage', name: 'Manage Legal Register', description: 'Create/edit legal register entries', category: 'ims' },
      { id: 'ims.managementReview.view', name: 'View Management Reviews', description: 'View management review reports (ISO §9.3)', category: 'ims' },
      { id: 'ims.managementReview.manage', name: 'Manage Management Reviews', description: 'Create/edit management review reports', category: 'ims' },
      { id: 'ims.managementReview.approve', name: 'Approve Management Reviews', description: 'Lock and approve management review reports', category: 'ims' },
      { id: 'ims.audits.view', name: 'View Audit Tracker', description: 'View internal audit plans and findings (ISO §9.2)', category: 'ims' },
      { id: 'ims.audits.manage', name: 'Manage Audit Plans', description: 'Create and manage audit plans', category: 'ims' },
      { id: 'ims.audits.conduct', name: 'Conduct Audits', description: 'Record audit findings and close findings', category: 'ims' },
      { id: 'ims.calibration.view', name: 'View Calibration Register', description: 'View calibration register (ISO §7.1.5)', category: 'ims' },
      { id: 'ims.calibration.manage', name: 'Manage Calibration', description: 'Update calibration records and status', category: 'ims' },
      { id: 'ims.competence.view', name: 'View Competence Matrix', description: 'View competence matrix (ISO §7.2)', category: 'ims' },
...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  Manager: [
    ...
    'ims.risks.treat',
    'ims.dashboard.view',
    'ims.legalRegister.view',
    'ims.legalRegister.manage',
    'ims.managementReview.view',
    'ims.managementReview.manage',
    'ims.managementReview.approve',
    'ims.audits.view',
    'ims.audits.manage',
    'ims.audits.conduct',
