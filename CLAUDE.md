...
**Current version:** `17.22.0` — payment schedule enhancements (clickable cards, totals, timeline totals, month arrows, CEO widget), project tracker active filter default, migration SQL fix
