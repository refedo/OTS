...
**Current version:** `19.11.1` — **Patch:** COGS Supplier Map redesign — accordion tree view replaces treemap as default; full GL account names visible; expand any account to see ranked suppliers with spend, invoice count, and % share bar; "Visual Map" toggle preserves treemap; Expand All / Collapse All controls.
