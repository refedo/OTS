...
**Current version:** `17.18.0` — Full-page tracker, clickable thumbnails, backlog note edit/delete, governance buildings+project col, task soft-delete recovery, search revision, LCR sort fix
